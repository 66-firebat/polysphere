...
QtObject {
    ...
    // Custom properties used by moon.qml / notifications.qml
    readonly property string serpantinumDir: home + "/.config/hypr"
    readonly property string qsDir: serpantinumDir + "/scripts/quickshell"
